...
# from llmfoundry.models.utils.param_init_fns import module_init_fns  
# from llmfoundry.models.utils.param_init_fns import multihead_attention_init
# @module_init_fns.register("sparse_attention")
# def sparse_attention_init(module, **kwargs):
#     """Parameter-init hook so SparseAttention passes generic_param_init_fn_.

#     We simply forward to the same scheme used for Multi-Head Attention, because
#     SparseAttention’s internal weights are ordinary Linear layers.
#     """
#     if not isinstance(module, SparseAttention):
#         return False                # keep searching
#     return multihead_attention_init(module, **kwargs)
